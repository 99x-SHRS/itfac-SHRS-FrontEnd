    ...
    <div classNameName="container">
      ...
      <div className="row d-flex justify-content-center mt-4">
        <div className="col-sm-12 col-md-4 mt-4 mb-4">
          <div className="h-100 p-5 text-black rounded-3 shadow p-4 mb-4 bg-white">
        ...
        <div className="col-sm-12 col-md-4 mt-4 mb-4">
          <div className="h-100 p-5 text-black rounded-3 shadow p-4 mb-4 bg-white">
            ...
            <div className="card-text pt-2">
              <Link to="/account/settings/security-settings">
                <h5>Manage account security...</h5>
              </Link>
            </div>
          </div>
        </div>
