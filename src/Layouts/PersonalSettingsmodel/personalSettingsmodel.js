...
function Personalsettingsmodel() {
  return (
            ...
            <ul className="list-group mb-3">
              <li className="list-group-item active d-flex justify-content-center lh-base border-0">
                <div>
                  ...
                  <h6 className="d-inline">Personal Details</h6>
                </div>
              </li>
              <li className="list-group-item d-flex justify-content-center lh-base border-0">
                <div>
                  ...
                  <h6 className="d-inline-flex m-2">Security</h6>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="col-md-7 col-lg-8">
            <div className="py-5">
              ...
              <div className="text-center">
                ...
                <p className="lead">You can edit your personal informations here....</p>
              </div>
            </div>
...
export default Personalsettingsmodel;
